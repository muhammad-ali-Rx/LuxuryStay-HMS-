...
import { Calendar, Clock, User, MapPin, Star, Edit, XCircle, CheckCircle } from "lucide-react"
...
const UserReservations = () => {
  ...
  const canCancel = (reservation) => {
    ...
    return hoursDifference > 2 && ['pending', 'confirmed'].includes(reservation.status)
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#0A1F44] to-[#1a365d] text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-300">Manage your restaurant bookings</p>
        </div>
      </div>
              ...
              >
                <div className="p-6">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start gap-4">
                        <img
                          src={reservation.restaurant?.images?.[0] || "/api/placeholder/100/100"}
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 mb-2">{reservation.restaurant?.cuisine}</p>
                    ...
                    <div className="text-right">
                      ...
                      {reservation.assignedTable && (
                        <p className="text-sm text-gray-600">Table: {reservation.assignedTable}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3 mt-6 pt-4 border-t border-gray-200">
                    ...
                    {reservation.status === 'completed' && !reservation.feedback && (
                      <button
                        onClick={() => {
                          ...
                          if (rating && comment) {
                            handleAddFeedback(reservation._id, parseInt(rating), comment)
                          }
                        }}
                    ...
                    <button
                      onClick={() => navigate(`/restaurants/${reservation.restaurant?._id}`)}
